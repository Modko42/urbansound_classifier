original_genres = ["air_conditioner","car_horn","children_playing","dog_bark","drilling","engine_idling","gun_shot","jackhammer","siren","street_music"];
genres = [""]
for first_class=1:10
    for second_class=first_class:10
        if first_class ~= second_class
            
            genres(end+1) = original_genres(first_class)+'-'+original_genres(second_class);
        end
    end
end
