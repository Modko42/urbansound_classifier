...
directory = "E:/temp_location/original_sets/base_spec_random_bgnoiseminus3db/train/"
for g in genres:
    genre_avg = []
    ...
    for f in test_files:
        shutil.move(directory + f"{g}" + "/" + f, "E:/temp_location/original_sets/base_spec_random_bgnoiseminus3db/test/" + f"{g}")
